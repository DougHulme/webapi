...
{
    public class ClientReadOnly : BaseModel 
    {
        // These fields hold the values for the public properties.
        private int id;
        private bool? isActive;
        private List<Models.ClientContactReadOnly> contacts;
        private List<Models.ClientAttributeReadOnly> attributes;
        private double? accountBalance;
        private double? accountCredit;
        private double? accountOutstanding;
        private string currencyCode;
        private string organizationName;
        private List<Models.ClientBankAccountReadOnly> bankAccounts;
        private List<Models.ClientTagReadOnly> tags;
        private string invitationEmailSentDate;
        private bool? isArchived;
        private bool? usesProforma;
        ...
        /// <summary>
        /// If `true`, this client has access to Client Zone
        /// </summary>
        ...
        public List<Models.ClientContactReadOnly> Contacts 
        { 
            get 
            {
        ...
        public List<Models.ClientAttributeReadOnly> Attributes 
        { 
            get 
            {
        ...
        /// <summary>
        /// The positive number means that the client has a credit, otherwise a debit.
        /// </summary>
        ...
        { 
            ...
            set 
            {
                ...
                onPropertyChanged("AccountCredit");
            }
        }
        ...
        /// TODO: Write general description for this method
        /// </summary>
        [JsonProperty("accountOutstanding")]
        public double? AccountOutstanding 
        { 
            get 
            {
            ...
            set 
            {
                this.accountOutstanding = value;
                onPropertyChanged("AccountOutstanding");
            }
        }
        ...
        public List<Models.ClientBankAccountReadOnly> BankAccounts 
        { 
            get 
            {
        ...
        /// </summary>
        [JsonProperty("tags")]
        public List<Models.ClientTagReadOnly> Tags 
        { 
            get 
            {
                return this.tags; 
        ...
        /// <summary>
        /// Date string in ISO 8601 format. Null if the user was not invited yet.
        /// </summary>
        [JsonProperty("invitationEmailSentDate")]
        public string InvitationEmailSentDate 
        { 
            get 
            {
            ...
            set 
            {
                this.invitationEmailSentDate = value;
                onPropertyChanged("InvitationEmailSentDate");
            }
        }

        /// <summary>
        /// If `true`, client is archived.
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("usesProforma")]
        public bool? UsesProforma 
        { 
            get 
            {
                return this.usesProforma; 
            } 
            set 
            {
                this.usesProforma = value;
                onPropertyChanged("UsesProforma");
            }
        }
