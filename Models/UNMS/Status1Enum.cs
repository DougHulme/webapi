...
namespace webapi.Models
{
    ...
    public enum Status1Enum
    {
        ...
        PAUSED, //TODO: Write general description for this method
    ...
    public static class Status1EnumHelper
    {
        ...
        private static List<string> stringValues = new List<string> { "created", "pending", "active", "cancelled", "paused", "error" };
        ...
        public static string ToValue(Status1Enum enumValue)
        {
            switch(enumValue)
            {
                ...
                case Status1Enum.CREATED:
                case Status1Enum.PENDING:
                case Status1Enum.ACTIVE:
                case Status1Enum.CANCELLED:
                case Status1Enum.PAUSED:
